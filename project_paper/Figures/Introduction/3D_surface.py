...
if __name__ == "__main__":
    ...
    # Scenario A: A free energy barrier present for all lambda states
    ...
    ax1.set_xlabel('Collective variable', fontsize='10', fontweight='bold')
    ax1.set_xlim3d(0, 13)
    ax1.set_ylabel('Alchemical variable',
                    fontsize='10', fontweight='bold')
    ax1.set_ylim3d(0, 1)
    ax1.set_zlim3d(0, 40)
    ax1.text(-0.5, 0, 60, 'Scenario A', weight='bold', fontsize=18)
    ax1.set_zlabel('Free energy ($ kT$)',
                    fontsize='10', fontweight='bold')

    # Scenario B: Deep free energy basins in the alchemical space
    ...
    ax2.set_ylim3d(0, 1)
    ax2.set_zlim3d(0, 40)
    ax2.text(-0.5, 0, 60, 'Scenario B', weight='bold', fontsize=18)
    ax2.set_zlabel('Free energy ($ kT$)',
                    fontsize='10', fontweight='bold')          
    plt.tight_layout(rect=[0, 0.03, 1, 0.95])
    plt.savefig('EXE_issues.png', dpi=600)
